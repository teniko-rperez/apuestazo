...
const NAV_ITEMS = [
  ...
  { href: "/nba", label: "NBA", mobileLabel: "NBA", icon: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <path d="M4.93 4.93c4.08 3.05 7.97 3.05 14.14 0" fill="none" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  )},
  { href: "/mlb", label: "MLB", mobileLabel: "MLB", icon: (
